...
-- LIMIT : 중간 record만 조회
SELECT * FROM Customers WHERE CustomerID ORDER BY CustomerID LIMIT 3, 3; -- 3번 인덱스부터 3개
...
-- 10번째 가격이 비싼 상품 조회
SELECT * FROM Products ORDER BY Price DESC LIMIT 9, 1; -- 조회
