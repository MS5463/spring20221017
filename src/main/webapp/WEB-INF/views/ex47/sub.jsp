...
<body>
	...
	<button id="btn1">[1] /ex47/sub01 json 응답</button> <br>
	
	
	<button id="btn2">[2] /ex47/sub01 json 응답</button> <br>
	
	
	<button id="btn3">[3] /ex47/sub03 json 응답</button> <br>
	
	
	<button id="btn4">[4] /ex47/sub04 30번 customer json 응답</button> <br>
	
	
	<button id="btn5">[5] /ex47/sub05 2번 supplier json 응답</button> <br>
	
	
	<input type="number" placeholder="고객번호" id="customerIdInput1" value="1"> 
	<br>
	<button id="btn6">[6] /ex47/sub06/customerId, customer json 응답</button> <br>
	
	
	<input type="number" placeholder="공급자번호" id="supplierIdInput1" value="1">
	<br>
	<button id="btn7">[7] /ex47/sub07/customerId, supplier json 응답</button> <br>
	
	
	<input type="number" placeholder="고객번호" id="customerIdInput8" value="1">
	<br>
	<button id="btn8">[8] /ex47/sub08/customerId, customer json 응답 </button>
	...
	<br>
	<button id="btn9">[9] /ex47/sub09/supplierId, supplier json 응답</button>
	...
	<button id="btn10">[10] /ex47/sub10 put 요청 : 고객정보 update</button> <br>
	...
	<button id="btn12">/ex47/sub12 post 요청 : 고객정보 insert</button> <br>
	
	
	<button id="btn13">/ex47/sub13 post 요청 : 공급자정보 insert</button> <br>
	
	
	<button id="btn14">/ex47/sub14 delete 요청 : 고객정보 delete</button> <br>
