...
<body>
	...
	<button id="btn1">/ex44/sub01 post 요청 w/ data</button> <br> 
	
	<button id="btn2">/ex44/sub02 post 요청 w/ data text/plain</button> <br>
	
	<button id="btn3">/ex44/sub03 post 요청 w/ data application/json</button> <br> 
	
	<button id="btn4">/ex44/sub04 post 요청 json</button> <br>
	
	<button id="btn5">/ex44/sub05 post 요청 json</button> <br> 
	
	<button id="btn6">/ex44/sub06 post 요청 json</button> <br> 
	
	<button id="btn7">/ex44/sub07 post 요청 json</button> <br> 
	
	<button id="btn8">/ex44/sub03 post 요청 obj → json</button> <br>
	
	<button id="btn9">/ex44/sub05 post 요청 obj → json</button> <br> 
	
	<button id="btn10">/ex44/sub04 post 요청 obj → json</button> <br> 
	
	<button id="btn11">/ex44/sub03 post 요청 form → obj → json</button>
	<form action="" id="form1">
		<input type="text" name="name" id="nameInput1" value="Kim">
		<input type="text" name="address" id="addressInput1" value="korea">
	</form> <br> 
	
	<button id="btn12">/ex44/sub06 post 요청 form → obj → json</button> <br>
	<input type="text" id="nameInput2" value="박"> 
	<br>
	<input type="text" id="locationInput2" value="런던"> 
	<br>
	<input type="text" id="sinceInput2" value="2002"> <br> 
	
	<button id="btn13">/ex44/sub04 post 요청 form → obj → json</button> <br>
	...
	<br>
	<input type="text" id="nameInput14">
	<br>
	<input type="date" id="dateInput14">
	<br>
...
<script>
	...
	document.querySelector("#btn5").addEventListener("click", function() {
		fetch(ctx + "/ex44/sub05", {
			...
			body : `{"address":"seoul", "score":3.14, "phone":["Galaxy", "iPhone"], "married":true}`
		});
	});
	...
	document.querySelector("#btn6").addEventListener("click", function() {
		fetch(ctx + "/ex44/sub06", {
			...
			body : '{"name":"son", "job":{"location":"london", "since":"2000"}}'
		});
	});
	...
	document.querySelector("#btn9").addEventListener("click", function() {
		const o = {address : "seoul", score : 66.6, phone : {Galaxy, iPhone}, married : true};
		const data = JSON.stringify(o);
