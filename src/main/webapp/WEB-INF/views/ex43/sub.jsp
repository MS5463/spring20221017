...
<body>
	<h1>서버로 데이터 전송</h1>
	<button id="btn1">/ex43/sub01 get 요청</button> <br>
	
	<button id="btn2">/ex43/sub02 get 요청</button> <br>
	
	<button id="btn3">/ex43/sub03 get 요청</button> <br>
	...
	<button id="btn5">/ex43/sub05 post 요청</button> <br>
	
	<button id="btn6">/ex43/sub06 post 요청</button> <br>
	
	<button id="btn7">/ex43/sub07 post 요청</button> <br>
...
<script>
	...
	document.querySelector("#btn2").addEventListener("click", function(){
		fetch(ctx + "/ex43/sub02?email=ab+c@gmail.com&age=20"); // + 를 넣을경우 띄어쓰기
	});
	...
	document.querySelector("#btn6").addEventListener("click", function(){
		fetch(ctx + "/ex43/sub06", {
			...
			body : "name=kim&email=a+b+c@gmail.com"
		});
	});
