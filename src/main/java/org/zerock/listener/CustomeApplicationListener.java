...
public class CustomeApplicationListener implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce)  { 
    	...
    	// https://sduty-2022-08-08-ms5463.s3.ap-northeast-2.amazonaws.com/prj1/board
    	ServletContext application = sce.getServletContext();
    	application.setAttribute("imgUrl", "https://sduty-2022-08-08-ms5463.s3.ap-northeast-2.amazonaws.com/prj1/board");
    }
