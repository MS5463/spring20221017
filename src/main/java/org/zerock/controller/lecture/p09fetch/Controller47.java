...
public class Controller47 {
	...
	@GetMapping("sub01")
	@ResponseBody
	public Map<String, String> method01() {
	...
	@GetMapping("sub04")
	@ResponseBody
	public JavaBean18 method04() {
		return mapper.getCustomerById(30);
	}
	
	@GetMapping("sub05")
	@ResponseBody
	public JavaBean19 method05() {
		return mapper.getSupplierById(2);
	}
	
	@GetMapping("sub06/{id}")
	@ResponseBody
	public JavaBean18 method06(@PathVariable int id) {
		return mapper.getCustomerById(id);
	}
	
	@GetMapping("sub07/{id}")
	@ResponseBody
	public JavaBean19 method07(@PathVariable int id) {
		return mapper.getSupplierById(id);
	}
	
	@GetMapping("sub08/{id}")
	@ResponseBody
	public Map<String, Object> method08(@PathVariable int id) {
	...
	@GetMapping("sub09/{id}")
	@ResponseBody
	public Map<String, Object> method09(@PathVariable int id) {
		Map<String, Object> map = new HashMap<>();
	...
	public Map<String, String> method12(@RequestBody JavaBean18 customer) {
		...
		if (cnt == 1) {
			map.put("message", customer.getId() + "번 고객 정보가 입력되었습니다.");
		} else { 
			map.put("message", customer.getId() + "고객 정보가 입력되지 않았습니다");
		}
